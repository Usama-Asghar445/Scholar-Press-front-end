...
import PaperManagement from "../../../components/dashboard/reviewer/PaperManagement";
        ...
        return (
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 lg:p-8 min-h-[calc(100vh-140px)] flex flex-col items-center justify-center text-center">
            ...
            <p className="text-gray-500 max-w-lg">
              Welcome to the Reviewer Dashboard. This section is currently under construction.
            </p>
          </div>
        );
    }
