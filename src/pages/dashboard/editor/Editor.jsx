...
import AssociateEditorsList from "../../../components/dashboard/editor/AssociateEditorsList";
import ReviewersList from "../../../components/dashboard/editor/ReviewersList";

const navItems = [
  { id: "dashboard", label: "Dashboard", icon: FaHome },
  { id: "managePapers", label: "Manage Papers", icon: FaFileAlt },
  { id: "associateEditors", label: "Associate Editors", icon: FaUsers },
...
function Editor() {
  ...
  const sectionSubtitles = {
    ...
    managePapers: user?.fieldOfStudy
      ...
      : "Please complete your profile with a field of study to view related papers.",
    associateEditors: user?.fieldOfStudy
      ? `Associate Editors in your field of study: ${user.fieldOfStudy}`
      : "Please complete your profile with a field of study to view related editors.",
    reviewers: user?.fieldOfStudy
      ? `Peer Reviewers in your field of study: ${user.fieldOfStudy}`
      : "Please complete your profile with a field of study to view related reviewers.",
        ...
        <div className="flex-1 bg-gray-50 overflow-y-auto w-full">
          <main className="p-4 sm:p-6 lg:p-8 w-full max-w-7xl mx-auto min-h-[calc(100vh-80px)]">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                  ...
                  {userLoading || loadingPapers ? (
                    ...
                    <div className="text-center py-24">
                      ...
                      <p className="text-gray-500 mt-3">
                        Please update your profile with your field of study so
                        the editor dashboard can load related papers.
                      </p>
                    </div>
              ...
              ) : activeSection === "associateEditors" ? (
                <AssociateEditorsList />
              ) : activeSection === "reviewers" ? (
                <ReviewersList />
              ) : (
                <div className="flex flex-col items-center justify-center p-20 bg-gray-50 rounded-2xl border border-gray-200">
                  <p className="text-gray-600 font-bold uppercase tracking-widest text-sm">
                    {activeSection}
                  </p>
                  <p className="text-gray-400 text-xs mt-2 italic font-medium">
