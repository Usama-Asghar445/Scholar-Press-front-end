...
const FIELD_OPTIONS = ["Physics", "Computer Science", "Biography"];
...
const AddPaperForm = ({ user, onCancel, onSuccess }) => {
  ...
  const validate = () => {
    ...
    if (!paperDetails.field)
      newErrors["paperDetails.field"] = "Main field is required";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      finalData.append("paperDetails", JSON.stringify(formData.paperDetails));
      finalData.append("authors", JSON.stringify(formData.authors));
            ...
            <div className="space-y-6 animate-fadeIn">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    name="field"
                    value={formData.paperDetails.field}
                    onChange={handlePaperDetailsChange}
                    className={`w-full p-3.5 rounded-xl border transition-all ${errors["paperDetails.field"] ? "border-red-300 bg-red-50" : "border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none"}`}
                  >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="subField"
                    value={formData.paperDetails.subField}
                    onChange={handlePaperDetailsChange}
                    className="w-full p-3.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                    placeholder="e.g. Quantum Algorithms, Machine Learning, Literary Analysis"
                  />
                </div>
